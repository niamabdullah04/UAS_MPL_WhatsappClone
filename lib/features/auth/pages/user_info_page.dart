...
import 'package:flutter_application_wa/sistem/widgets/short_h_bar.dart';
import 'package:flutter_application_wa/features/auth/pages/image_picker_page.dart';
...
class _UserInfoPageState extends ConsumerState<UserInfoPage> {
  ...
  saveUserDataToFirebase() {
    ...
    ref.read(authnControllerProvider).saveUserInfoToFirestore(
          username: username,
          profileImage:
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            Text(
              'Please your provider Name and an Optional profile photo',
